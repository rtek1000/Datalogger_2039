...
static USBH_StatusTypeDef USBH_HID_KeybdDecode(USBH_HandleTypeDef *phost) {
	...
	if (USBH_HID_FifoRead(&HID_Handle->fifo, &keybd_report_data,
		...
		keybd_info.key_special = keybd_info.ralt;
		keybd_info.key_special |= keybd_info.rctrl << 1;
		keybd_info.key_special |= keybd_info.rgui << 2;
		keybd_info.key_special |= keybd_info.rshift << 3;

		keybd_info.key_special |= keybd_info.lalt << 4;
		keybd_info.key_special |= keybd_info.lctrl << 5;
		keybd_info.key_special |= keybd_info.lgui << 6;
		keybd_info.key_special |= keybd_info.lshift << 7;
